...
declare module "universal-router/generateUrl" {
   ...
   */
  export default function generateUrls(router: UniversalRouter, options?: Options): (routeName: string, params?: Params) => string;
}
